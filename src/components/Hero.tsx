  ...
  useEffect(() => {
    ...
    const runAnimation = () => {
      ...
      tl
        ...
        .to('.beam-top', { top: '0%', duration: 0.25, ease: 'expo.inOut' }, '+=0.01')
        .to('.beam-bot', { top: '100%', duration: 0.25, ease: 'expo.inOut' }, '<')
        .to('.ares-text', {
          clipPath: 'inset(0% 0 0% 0)', opacity: 1,
          duration: 0.25, ease: 'expo.inOut',
        }, '<')
        .to('.laser-scan', {
          opacity: 1, left: '100%', duration: 0.35, ease: 'power2.inOut',
        }, '<')
        .to('.laser-scan', { opacity: 0, duration: 0.1 }, '>')
        .to('.ares-text', { filter: 'brightness(1) contrast(1)', duration: 0.08 })
        .to('.ares-text', {
          opacity: 0.4, duration: 0.03, repeat: 3, yoyo: true, ease: 'none',
        })
        .to('.ares-text', { opacity: 1, duration: 0.06 })
        .to('.beam-line', { opacity: 0, duration: 0.1, ease: 'power2.out' }, '-=0.06')
    ...
    <section ref={containerRef} id="home" className="relative h-screen w-full overflow-hidden bg-black">
      ...
      <div className="relative z-20 h-full flex flex-col items-center justify-center text-center px-6 gap-0">
        ...
        <div className="hero-countdown opacity-0 mt-6 flex flex-col items-center gap-3 pointer-events-none">
          ...
          {/* Date badge */}
          <div
            className="text-[20px] tracking-[0.35em] text-neon-red/70 uppercase mt-1"
        ...
        <div className="space-y-4 mt-6 px-4">
          ...
          <div className="hero-cta flex flex-col sm:flex-row gap-6 justify-center opacity-0 mt-6">
            <MagneticButton
              className="bg-neon-red text-black hover:shadow-[0_0_30px_rgba(255,0,60,0.5)]"
