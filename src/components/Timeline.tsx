...
export const Timeline = () => {
  ...
  useGSAP(() => {
    ...
    gsap.to(sections, {
      ...
      scrollTrigger: {
        ...
        end: () => "+=" + (scrollRef.current?.offsetWidth || 0) * 3,
      }
    });
  ...
  const events = [
    { day: 'DAY 01', title: 'coming soon', time: 'Coming Soon', desc: 'coming soon' },
    { day: 'DAY 01', title: 'coming soon', time: 'Coming Soon', desc: 'coming soon' },
    { day: 'DAY 01', title: 'coming soon', time: 'Coming Soon', desc: 'coming soon' },
    { day: 'DAY 02', title: 'coming soon', time: 'Coming Soon', desc: 'coming soon' },
    { day: 'DAY 02', title: 'coming soon', time: 'Coming Soon', desc: 'coming soon' },
    { day: 'DAY 02', title: 'coming soon', time: 'Coming Soon', desc: 'coming soon' },
    { day: 'DAY 03', title: 'coming soon', time: 'Coming Soon', desc: 'coming soon' },
    { day: 'DAY 03', title: 'coming soon', time: 'Coming Soon', desc: 'coming soon' },
    { day: 'DAY 03', title: 'coming soon', time: 'Coming Soon', desc: 'coming soon' },
  ];
