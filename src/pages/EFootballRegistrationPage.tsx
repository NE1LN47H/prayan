                ...
                >
                    <div className="relative rounded-2xl overflow-hidden border border-white/8"
                        ...
                        <div className="px-8 py-20 flex flex-col items-center justify-center gap-8 relative overflow-hidden text-center">
                            ...
                            <a
                                href="https://docs.google.com/forms/d/e/1FAIpQLScVdVpGeZeMIloWekO3frOvMu6xuQ7KPNxzAdcvzY2FzUq6qQ/viewform"
                                target="_blank"
                ...
                >
                    <div className="relative rounded-2xl overflow-hidden border border-white/8 p-8 md:p-12"
                        ...
                        <div className="flex items-center gap-4 mb-8">
                            ...
                            <h2 className="text-2xl font-display font-bold tracking-wider uppercase text-white">E-Football Tournament</h2>
                        </div>
