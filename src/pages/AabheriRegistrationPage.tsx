...
import { ArrowLeft, ShieldAlert, Music } from 'lucide-react';

export default function AabheriRegistrationPage() {
    return (
            ...
            <div className="relative z-10 flex-1 flex flex-col items-center px-4 py-12 md:py-16">
                ...
                >
                    ...
                    <p className="text-white/40 text-sm tracking-widest uppercase max-w-md mx-auto">
                        Campus in Rhythm<span className="ml-1">🎶</span>
                    </p>

                    {/* Coordinators Highlight */}
                    <div className="pt-8 pb-4 flex flex-col items-center gap-6">
                        <div className="flex flex-col items-center">
                            <span className="text-neon-red text-[10px] uppercase tracking-[0.4em] font-bold opacity-80 mb-2">AABHERI'26 COORDINATORS</span>
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-8 md:gap-12">
                            ...
                            <div className="flex flex-col items-center gap-3 group">
                                <div className="flex items-center gap-4 py-2 px-6 rounded-2xl glass border border-white/5 group-hover:border-neon-red/30 transition-all duration-300">
                                    <span className="text-white text-lg font-display font-bold tracking-tight">Navadev</span>
                                    <a
                                        href="https://wa.me/+919526973132"
                                ...
                                <span className="text-white/30 text-[9px] uppercase tracking-[0.2em]">Navadev - 9526973132</span>
                            </div>

                            {/* Coordinator 2 */}
                            <div className="flex flex-col items-center gap-3 group">
                                <div className="flex items-center gap-4 py-2 px-6 rounded-2xl glass border border-white/5 group-hover:border-neon-red/30 transition-all duration-300">
                                    <span className="text-white text-lg font-display font-bold tracking-tight">Arunthathi</span>
                                    <a
                                        href="https://wa.me/+919544734980"
                                        className="px-4 py-1.5 rounded-xl text-[10px] font-mono tracking-widest uppercase bg-neon-red/10 text-neon-red border border-neon-red/20 hover:bg-neon-red hover:text-black transition-all duration-300"
                                    >
                                        Contact
                                    </a>
                                </div>
                                <span className="text-white/30 text-[9px] uppercase tracking-[0.2em]">Arunthathi - 9544734980</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4 justify-center pt-2">
                        ...
                        <span className="text-neon-red/40 text-[9px] font-mono tracking-[0.4em] uppercase">Deadline: March 18 · Online</span>
                ...
                >
                    <div className="relative rounded-2xl overflow-hidden border border-white/8"
                        ...
                        <div className="px-8 py-20 flex flex-col items-center justify-center gap-8 relative overflow-hidden text-center">
                            ...
                            <a
                                href="https://docs.google.com/forms/d/e/1FAIpQLSd8uqH97Udn7a9_ZhwmlpwSwWOBwdMhIUGIxpJubvb9q7bqEA/viewform"
                                target="_blank"
                            ...
                            >
                                ...
                                <div className="relative flex flex-col items-center">
                                    ...
                                    <span className="text-[10px] sm:text-[11px] tracking-[0.4em] sm:tracking-[0.6em] text-neon-red font-bold uppercase opacity-80 mt-2">Open Google Form</span>
                                </div>
                            </a>

                            <div className="flex flex-col items-center gap-4">
                                <p className="text-white/30 text-[10px] uppercase tracking-[0.4em] max-w-sm leading-relaxed font-mono">
                                    Or submit via WhatsApp (as document)
                                </p>
                                <div className="flex gap-4">
                                    <a 
                                        href="https://wa.me/+919526973132"
                                        className="text-[10px] px-4 py-2 rounded-full border border-white/20 text-white/60 hover:border-neon-red/50 hover:text-white transition-all duration-300 uppercase tracking-widest font-mono no-underline"
                                    >
                                        Navadev
                                    </a>
                                    <a 
                ...
                >
                    <div className="relative rounded-2xl overflow-hidden border border-white/8 p-8 md:p-12"
                        ...
                        <div className="flex items-center gap-4 mb-8">
                            ...
                            <h2 className="text-2xl font-display font-bold tracking-wider uppercase text-white">Guidelines</h2>
                        </div>

                        <ul className="space-y-6">
                            {[
                                "The competition is 'Campus in Rhythm🎶' - A premium music challenge.",
                                "Entries are allowed only for school, college, and institution students.",
                                "Submit your entry via WhatsApp (as a document) to the coordinators or through the official Google Form.",
                                "Each entry must be original and should represent the participant's campus and rhythm.",
                                "Submission deadline: March 18, 2026.",
                                "Coordinators: Navadev (9526973132) & Arunthathi (9544734980)."
                            ].map((rule, idx) => (
