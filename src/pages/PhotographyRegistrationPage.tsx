                ...
                >
                    ...
                    <div className="pt-8 pb-4 flex flex-col items-center gap-6">
                        <div className="flex flex-col items-center">
                            <span className="text-neon-red text-[10px] uppercase tracking-[0.4em] font-bold opacity-80 mb-2">CAPTURA'26 COORDINATORS</span>
                ...
                >
                    <div className="relative rounded-2xl overflow-hidden border border-white/8"
                        ...
                        <div className="px-8 py-20 flex flex-col items-center justify-center gap-8 relative overflow-hidden text-center">
                            ...
                            <a
                                href="https://docs.google.com/forms/d/e/1FAIpQLSfpo9oBubUHWdcqKhD_OlKDogCNnHsVfxMCaJCllqoxnsnUsA/viewform"
                                target="_blank"
                ...
                >
                    <div className="relative rounded-2xl overflow-hidden border border-white/8 p-8 md:p-12"
                        ...
                        <ul className="space-y-6">
                            {[
                                "The photograph must follow the theme \"Black & White Photography\". Participants can capture college life, nature, portraits, architecture, or creative concepts in black and white.",
                                "Participants must follow our Instagram pages: @prayan_vke & @syncify_edutech",
                                "Each student can submit only one photograph for the competition.",
                                "The photo must be original and captured by the participant.",
                                "Downloaded, AI-generated, or reposted images are not allowed. Such entries will be rejected.",
                                "A minimum of 200 likes and shares is required for the entry to qualify.",
                                "Last date for submission: March 18, 2026.",
                                "Winners will be selected based on: Creativity and composition, Photography skills, Black & white aesthetics, and Number of likes."
                            ].map((rule, idx) => (
